        ...
        <form method="post" enctype="multipart/form-data">
          <div class="md-form input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text md-addon" id="titlePostUpdate">Titre</span>
            </div>
            <input type="hidden" id="postId" value="<?= $post->{'id'}; ?>">
            <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroupMaterial-sizing-default" value="<?= $post->{'title'} ?>" id="myPostTitle" autocomplete="off">
          </div>
          <textarea id="update-article-form" style="min-height: 80vh; min-width: 100%" name="content"><?= $post->{'content'} ?></textarea>
        </form>
      </div>
    </div>
  </div>
