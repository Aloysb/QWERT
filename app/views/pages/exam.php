...
<body>
        ...
        <div class="row category__row">
          <div class="col-xs-12 col-sm-6 col-lg-4 offset-sm-0 category_col">
            <div class="category">
              ...
              <a class="category__link category__link--active" href="/pages/exam"><?php if ($data['notifBilan']) : ?><span class='notif'></span><?php endif; ?>Bilans</a>
  ...
  box-shadow: 0px 0px 4px 2px rgba(255, 0, 0, 0.3);"></span><?php endif; ?>
                    <?= $site['name']; ?><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-external-link" style="margin-bottom:5px">
